...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateDrinkRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateDrinkResponse$inboundSchema),
    M.bytes(200, operations.UpdateDrinkResponse$inboundSchema, {
      ctype: "application/xml",
    }),
    M.fail("4XX"),
    M.jsonErr("5XX", errors.APIError$inboundSchema),
    M.json("default", operations.UpdateDrinkResponse$inboundSchema),
