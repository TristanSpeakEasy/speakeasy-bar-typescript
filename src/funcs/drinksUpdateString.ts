...
export enum UpdateStringAcceptEnum {
 ...
 */
export function drinksUpdateString(
  client: SpeakeasyBarCore,
  request: operations.UpdateDrinkStringRequest,
  options?: RequestOptions & { acceptHeaderOverride?: UpdateStringAcceptEnum },
): APIPromise<
  Result<
    operations.UpdateDrinkStringResponse,
    | errors.APIError
    | SpeakeasyBarError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateDrinkStringResponse$inboundSchema),
    M.bytes(200, operations.UpdateDrinkStringResponse$inboundSchema, {
      ctype: "application/xml",
    }),
    M.fail("4XX"),
    M.jsonErr("5XX", errors.APIError$inboundSchema),
    M.json("default", operations.UpdateDrinkStringResponse$inboundSchema),
