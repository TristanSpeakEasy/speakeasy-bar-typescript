 ...
 */
export function drinksUpdateRaw(
  ...
  Result<
    operations.UpdateDrinkRawResponse,
    | errors.APIError
    | SpeakeasyBarError
...
> {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.UpdateDrinkRawResponse$inboundSchema),
    M.bytes(200, operations.UpdateDrinkRawResponse$inboundSchema, {
      ctype: "application/xml",
    }),
    M.fail("4XX"),
    M.jsonErr("5XX", errors.APIError$inboundSchema),
    M.json("default", operations.UpdateDrinkRawResponse$inboundSchema),
