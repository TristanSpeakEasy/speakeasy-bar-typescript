...
export function drinksSearch(
  ...
  Result<
    operations.SearchDrinksResponse,
    | errors.APIError
    | SpeakeasyBarError
...
> {
  ...
  const path = pathToFunc("/drinks/search")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SearchDrinksResponse$inboundSchema),
    M.fail("4XX"),
    M.jsonErr("5XX", errors.APIError$inboundSchema),
    M.json("default", operations.SearchDrinksResponse$inboundSchema),
